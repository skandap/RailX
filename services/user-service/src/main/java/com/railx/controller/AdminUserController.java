...
public class AdminUserController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<UserResponse>>> fetchAllData() {
        return new ResponseEntity<>(new ApiResponse<>(true, "Details fetched successfully.", userService.fetchAllUsers()), HttpStatus.OK);
    }
